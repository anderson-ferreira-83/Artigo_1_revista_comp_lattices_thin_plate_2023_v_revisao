...
\textcolor{red}{To ensure fair comparison across different lattice configurations operating at different frequency ranges, this study employs both absolute and relative bandgap width analysis. Following the methodology recommended by the metamaterial community, the relative bandgap width is defined as:
\begin{equation}
\eta_{rel} = \frac{f_2 - f_1}{f_c} \times 100\%
\label{eq:relative_bandwidth}
\end{equation}
where $f_c = (f_1 + f_2)/2$ is the center frequency of the bandgap, and $\eta_{rel}$ represents the relative bandwidth efficiency. This normalized metric enables objective performance comparison independent of absolute frequency ranges, complementing the absolute bandwidth analysis (FBGW in Hz) which provides practical engineering insights for specific frequency targets.}
...
\textcolor{red}{The absolute bandwidth analysis (FBGW in Hz) presented above provides critical insights for engineering applications with specific frequency targets, enabling designers to select lattice configurations based on the actual bandwidth required at predetermined frequencies. For instance, if an application requires maximum attenuation at 145 Hz, the triangular lattice with 55.40 Hz absolute bandwidth is the optimal choice. However, this comparison alone does not account for the fact that different lattices achieve their maximum performance at different frequency ranges (triangular at 145 Hz vs square at 105 Hz), potentially biasing conclusions toward configurations operating at higher frequencies where absolute bandwidth naturally increases.}
...
\textcolor{red}{Established performance hierarchies: triangular lattices achieve 35\% superior relative bandwidth (42.51\% vs 31.40\% for square lattices), kagomé provides maximum attenuation, and PWE/EPWE delivers 1800-5700× efficiency over FEM with <1\% error.}
...
The investigation reveals a clear performance hierarchy with frequency-dependent optimization strategies: \textcolor{red}{triangular lattices achieve superior broadband performance with $35\%$ superior relative bandwidth compared to conventional square configurations (42.51\% vs 31.40\%)}; kagomé lattices provide exceptional low-frequency attenuation (up to 15 [dB] enhancement) through multi-resonator coupling; honeycomb configurations offer balanced dual-mode capability; square lattices deliver consistent mid-range performance; while rectangular lattices show limited effectiveness but enable directional control applications. This establishes a paradigm shift from geometry-only to combined geometry-frequency design approaches, with optimal lattice selection dependent on target frequency ranges and application requirements.
...
\hline
$f_j$ [Hz] & Square & Rect. & Triang. & Hon.$_1$ & Hon.$_2$ & Kag.$_1$ & Kag.$_2$ \\
\hline
150 & 36.1 & 33.7 & 36.4 & 35.8 & 0.0 & \textbf{26.3} & 0.0 \\
175 & 43.2 & 39.2 & 43.8 & 42.5 & 0.0 & 16.9 & 10.7 \\
...
350 & 97.3 & 58.6 & 103.7 & 0.0 & 73.5 & 18.4 & 22.1 \\
375 & 113.4 & 81.4 & 120.9 & 0.0 & 77.4 & 11.7 & 24.2 \\
400 & 107.0 & 30.4 & 127.5 & 0.0 & 81.9 & 3.8 & 26.9 \\
425 & \textbf{131.1} & 74.7 & 145.8 & 0.0 & 87.0 & 0.0 & 26.6 \\
450 & 111.0 & 5.4 & 161.7 & 0.0 & 92.7 & 0.0 & 23.1 \\
475 & 111.0 & 30.7 & 172.1 & 0.0 & 98.9 & 0.0 & 20.0 \\
484$^*$ & 107.0 & 22.9 & 176.9 & 0.0 & \textbf{101.2} & 0.0 & 19.1 \\
500 & 89.9 & 0.0 & 198.4 & 0.0 & 105.3 & 0.0 & 17.8 \\
525 & 89.9 & 0.0 & 198.4 & 0.0 & 111.1 & 0.0 & 16.5 \\
575 & 71.7 & 0.0 & \textbf{222.0} & 0.0 & 113.7 & 0.0 & 16.4 \\
625 & 56.2 & 0.0 & 219.4 & 0.0 & 93.6 & 0.0 & 17.5 \\
725 & 31.5 & 0.0 & 196.1 & 0.0 & 62.9 & 0.0 & 17.4 \\
\hline
\multicolumn{8}{l}{\footnotesize $^*$Bragg frequency. Bold: maximum FBGW per lattice. Hon.=Honeycomb, Kag.=Kagomé, Rect.=Rectangular, Triang.=Triangular} \\
\multicolumn{8}{l}{\footnotesize Subscripts: $_1$=FBGW 1, $_2$=FBGW 2. Performance ranking (max FBGW): Triang. (222.0) $>$ Square (131.1) $>$ Hon.$_2$ (101.2)} \\
\multicolumn{8}{l}{\footnotesize $>$ Rect. (84.2) $>$ Hon.$_1$ (57.7) $>$ Kag.$_1$ (26.3) $>$ Kag.$_2$ (26.9)} \\
\end{tabular}
\end{table}}
...
$f_j$ [Hz] & Square & Rect. & Triang. & Hon.$_1$ & Hon.$_2$ & Kag.$_1$ & Kag.$_2$ \\
\hline
300 & 73.1 & 67.4 & 73.9 & 72.3 & 0.0 & \textbf{35.9} & 10.4 \\
...
650 & 191.4 & 136.7 & 201.5 & 0.0 & 135.5 & 30.3 & 41.2 \\
700 & 207.8 & 126.3 & 220.3 & 0.0 & 143.8 & 15.3 & 45.9 \\
750 & \textbf{231.8} & \textbf{151.7} & 253.7 & 0.0 & 153.5 & 0.0 & 51.5 \\
800 & 231.5 & 110.2 & 279.5 & 0.0 & 164.4 & 0.0 & 44.2 \\
850 & 207.3 & 66.4 & 305.9 & 0.0 & 176.4 & 0.0 & 37.7 \\
879$^*$ & 194.1 & 41.2 & 321.2 & 0.0 & \textbf{183.8} & 0.0 & 34.7 \\
900 & 164.4 & 0.0 & 334.0 & 0.0 & 189.2 & 0.0 & 32.9 \\
950 & 164.4 & 0.0 & 358.6 & 0.0 & 201.1 & 0.0 & 30.1 \\
1000 & 134.2 & 0.0 & 381.8 & 0.0 & 210.8 & 0.0 & 29.3 \\
1050 & 108.4 & 0.0 & 402.0 & 0.0 & 203.8 & 0.0 & 29.9 \\
1100 & 112.2 & 0.0 & \textbf{408.1} & 0.0 & 183.1 & 0.0 & 31.0 \\
1150 & 88.7 & 0.0 & 398.4 & 0.0 & 164.3 & 0.0 & 32.0 \\
1200 & 84.2 & 0.0 & 389.8 & 0.0 & 147.4 & 0.0 & 32.5 \\
\hline
\multicolumn{8}{l}{\footnotesize $^*$Bragg frequency. Bold: maximum FBGW per lattice. Hon.=Honeycomb, Kag.=Kagomé, Rect.=Rectangular, Triang.=Triangular} \\
\multicolumn{8}{l}{\footnotesize Subscripts: $_1$=FBGW 1, $_2$=FBGW 2. Performance ranking (max FBGW): Triang. (408.1) $>$ Square (231.8) $>$ Hon.$_2$ (183.8)} \\
\multicolumn{8}{l}{\footnotesize $>$ Rect. (151.7) $>$ Hon.$_1$ (105.2) $>$ Kag.$_2$ (51.5) $>$ Kag.$_1$ (35.9)} \\
\end{tabular}
\end{table}}
