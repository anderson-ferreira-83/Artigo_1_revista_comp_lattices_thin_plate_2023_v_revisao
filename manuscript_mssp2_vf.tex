...
Edge frequency evolution reveals asymmetric band gap formation: $f_1$ increases linearly with $f_j$ (direct resonator control), while $f_2$ saturates at Bragg limit $f_B = 117.91$ Hz—an intrinsic geometric ceiling independent of resonator tuning. Maximum bandwidth $\Delta f_{12} = 32.10$ Hz at $f_j = 105$ Hz represents optimal balance between local resonance (controlling $f_1$) and geometric dispersion (limiting $f_2$), with subsequent decay reflecting saturation as $f_2$ approaches $f_B$.
...
% Legenda externa compacta em formato tabular - Dual band gaps
\centering
\small
\begin{tabular}{@{}c@{\hspace{0.3em}}l@{\hspace{1.0em}}c@{\hspace{0.3em}}l@{\hspace{1.0em}}c@{\hspace{0.3em}}l@{}}
% Linha 1 - Band gaps (retângulos)
...
% Legenda externa compacta em formato tabular - Comparação todas lattices
\centering
\footnotesize
\begin{tabular}{@{}c@{\hspace{0.2em}}l@{\hspace{0.8em}}c@{\hspace{0.2em}}l@{\hspace{0.8em}}c@{\hspace{0.2em}}l@{}}
% Linha 1 - Single-resonator lattices
\tikz{%
...
% Linha 2 - Multi-resonator lattices
\tikz{%
...
\parbox[t]{3.2cm}{\footnotesize Kagomé - FBGW 1\\$\Delta f_{34} = 6.54$ Hz} \\[0.7em]

% Linha 3 - Kagomé FBGW 2
& &
\tikz{%
    \draw[line width=4pt, green!70!black, dashed] (0,0.18) -- (0.8,0.18);
    \fill[green!70!black] (0.27,0.0) rectangle (0.42,0.36);
} &
\parbox[t]{3.2cm}{\footnotesize Kagomé - FBGW 2\\$\Delta f_{45} = 6.85$ Hz} & & \\
