...
\footnotetext[2]{Bragg frequency calculated for square lattice configuration ($f_B = 484$ Hz).}
\end{table}}
...
\footnotetext[2]{Bragg frequency calculated for square lattice configuration ($f_B = 879$ Hz).}
\end{table}}
