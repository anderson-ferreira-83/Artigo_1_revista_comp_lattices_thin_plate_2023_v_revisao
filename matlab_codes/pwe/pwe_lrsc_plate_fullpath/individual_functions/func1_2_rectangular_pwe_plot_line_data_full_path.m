function func1_2_rectangular_pwe_plot_line_data_full_path = rectangular_dispersion(nmax_f,i_fi_f,i_ff_f,a_f,he_f,E_f,gamma_f,ro_f,ni_f,fr_f,eta_p_f)
...
label_file_w_kk = sprintf('2_1_a_%.2f_h_%g_lattice_r_res_%g_pwe_w_data_full_path.csv',lat_a,h,fr(1));
...
label_file_freq = sprintf('2_2_a_%.2f_h_%g_lattice_r_res_%g_pwe_f_data_full_path.csv',lat_a,h,fr(1));
