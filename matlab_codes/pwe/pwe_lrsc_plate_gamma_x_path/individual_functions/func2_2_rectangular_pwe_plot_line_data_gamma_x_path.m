function lattice2_rectangular_plot_scatter_no_norm_vt = rectangular_dispersion(nmax_f,i_fi_f,i_ff_f,a_f,he_f,E_f,gamma_f,ro_f,ni_f,fr_f,eta_p_f)
...
%%
label_file_w_kk = sprintf('2_1_a_%.2f_h_%g_lattice_r_res_%g_pwe_w_data_gamma_x_path.csv',lat_a,h,fr(1));
...
label_file_freq = sprintf('2_2_a_%.2f_h_%g_lattice_r_res_%g_pwe_f_data_gamma_x_path.csv',lat_a,h,fr(1));
