function func0_3_triangular_pwe_plot_line_data_full_path = triangular_dispersion(nmax_f,i_fi_f,i_ff_f,a_f,he_f,E_f,gamma_f,ro_f,ni_f,fr_f,eta_p_f)
...
label_file_w_kk = sprintf('3_1_a_%.2f_h_%g_lattice_t_bare_pwe_w_data_full_path.csv',lat_a,h);
...
label_file_freq = sprintf('3_2_a_%.2f_h_%g_lattice_t_bare_pwe_f_data_full_path.csv',lat_a,h);
